...
date_default_timezone_set('America/Edmonton');
	switch($_GET['q'])
	{
		...
		case "report4":
		{
			...
			echo "Specific Time Interval <input name='paramInclude' value='showInterval' onChange='displayReport45(this.checked, this.value), populateList(true)' type='radio'></input> | ";
			echo "Of all time <input name='paramInclude' value='showAll' onChange='displayReport45(this.checked, this.value), populateList(true)' type='radio'></input><br><br>";
			print("
					<div id='list' hidden>
						Select Volunteer <select class='test' name='people' id='List'>
						</select>
					</div><br><br>		
				<div id='all' hidden><br>	
				</div>
				<div id='specific' hidden><br>
					<input type='date' name='firstDate'> to <input type='date' name='secondDate'>
				</div>				
		...
		case "report5":
		{
			echo "Total Hours Worked For all volunteers: <br><br>";
			echo "Specific Time Interval <input name='paramInclude' value='showInterval' onChange='displayReport5(this.checked, this.value)' type='radio'></input> | ";
			echo "Of all time <input name='paramInclude' value='showAll' onChange='displayReport5(this.checked, this.value)' type='radio'></input><br>";
			print("
		...
		case "report8":
		{
			echo "Volunteer Email List: <br><br>";
			echo "All Volunteers <input value='hide1' name='paramInclude' onChange='testFunc(this.checked, this.value)' type='radio'></input>";
			echo "| Active Volunteers <input name='paramInclude' value='hide2' onChange='testFunc(this.checked, this.value)' type='radio'></input>";
			echo "| Specific Volunteers <input name='paramInclude' value='show' onChange='testFunc(this.checked, this.value), populateList(this.checked)' type='radio'></input>";
			echo "<div id='ShowSpecificParams' hidden><br>";
