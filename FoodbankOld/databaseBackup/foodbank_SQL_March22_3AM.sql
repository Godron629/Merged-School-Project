...
(74, 2, '2017-03-12', 'Front', 'Morning', 0);
...
--
ALTER TABLE `calendar_entry`
  MODIFY `calendar_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
--
-- AUTO_INCREMENT for table `clock_entry`
--
ALTER TABLE `clock_entry`
  MODIFY `clock_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
