<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/Foodbank/code/php/databaseFunctions.php";
	session_start(); 
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		if(isset($_POST['createBackupButton'])) {
	...
	<p><i>If you wish to create a backup of the database, click <a href='/Foodbank/databaseBackup/databaseBackup.php'>here.</a></i></p>";
	}
?>
